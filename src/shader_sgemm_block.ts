...
fn main(
  ...
  for(var k: u32 = 0u; k < KD4; k = k + 1u) {
    ...
    sum00 = fma(vec4<f32>(arow0.x), brow, sum00);
    sum01 = fma(vec4<f32>(arow1.x), brow, sum01);
    sum02 = fma(vec4<f32>(arow2.x), brow, sum02);
    sum03 = fma(vec4<f32>(arow3.x), brow, sum03);
    brow = array_b[(k * 4u + 0u) * ND4 + x * 2u + 1u];
    sum10 = fma(vec4<f32>(arow0.x), brow, sum10);
    sum11 = fma(vec4<f32>(arow1.x), brow, sum11);
    sum12 = fma(vec4<f32>(arow2.x), brow, sum12);
    sum13 = fma(vec4<f32>(arow3.x), brow, sum13);
    brow = array_b[(k * 4u + 1u) * ND4 + x * 2u + 0u];
    sum00 = fma(vec4<f32>(arow0.y), brow, sum00);
    sum01 = fma(vec4<f32>(arow1.y), brow, sum01);
    sum02 = fma(vec4<f32>(arow2.y), brow, sum02);
    sum03 = fma(vec4<f32>(arow3.y), brow, sum03);
    brow = array_b[(k * 4u + 1u) * ND4 + x * 2u + 1u];
    sum10 = fma(vec4<f32>(arow0.y), brow, sum10);
    sum11 = fma(vec4<f32>(arow1.y), brow, sum11);
    sum12 = fma(vec4<f32>(arow2.y), brow, sum12);
    sum13 = fma(vec4<f32>(arow3.y), brow, sum13);
    brow = array_b[(k * 4u + 2u) * ND4 + x * 2u + 0u];
    sum00 = fma(vec4<f32>(arow0.z), brow, sum00);
    sum01 = fma(vec4<f32>(arow1.z), brow, sum01);
    sum02 = fma(vec4<f32>(arow2.z), brow, sum02);
    sum03 = fma(vec4<f32>(arow3.z), brow, sum03);
    brow = array_b[(k * 4u + 2u) * ND4 + x * 2u + 1u];
    sum10 = fma(vec4<f32>(arow0.z), brow, sum10);
    sum11 = fma(vec4<f32>(arow1.z), brow, sum11);
    sum12 = fma(vec4<f32>(arow2.z), brow, sum12);
    sum13 = fma(vec4<f32>(arow3.z), brow, sum13);
    brow = array_b[(k * 4u + 3u) * ND4 + x * 2u + 0u];
    sum00 = fma(vec4<f32>(arow0.w), brow, sum00);
    sum01 = fma(vec4<f32>(arow1.w), brow, sum01);
    sum02 = fma(vec4<f32>(arow2.w), brow, sum02);
    sum03 = fma(vec4<f32>(arow3.w), brow, sum03);
    brow = array_b[(k * 4u + 3u) * ND4 + x * 2u + 1u];
    sum10 = fma(vec4<f32>(arow0.w), brow, sum10);
    sum11 = fma(vec4<f32>(arow1.w), brow, sum11);
